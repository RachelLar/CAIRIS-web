...
class Mitigate(Response,PropertyHolder):
  ...
  def effectiveness(self):
    if (self.theSecurityProperties == [0,0,0,0,0,0,0,0]): return 'None'
    elif (self.theSecurityProperties == [1,1,1,1,1,1,1,1]): return 'Low'
    elif (self.theSecurityProperties == [2,2,2,2,2,2,2,2]): return 'Medium'
    elif (self.theSecurityProperties == [3,3,3,3,3,3,3,3]): return 'High'
  ...
  def assetParameters(self,assetId = -1):
    ...
    assetProperties = [(cMitigated,iMitigated,avMitigated,acMitigated)]
